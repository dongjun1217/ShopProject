...
<input type="hidden" name="gAmount" value="${dto.gAmount}" >   
					<tr>
						...
						<td class="td_default" align="center" width="90">${dto.gAmount}</td>
...
<c:set var="a" value="${a +(dto.gPrice*dto.gAmount)}"/>
					...
					<tr>
						...
						<td class="td_default" align='right'><c:out value="${a}"/>
						</td>
					</tr>
				</table>
		<tr>
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						...
						<td height="35" class="td_default"><input
							...
							maxlength="200" value="${memberDTO.addr1}" readonly></input><br> <input
							class="input_default" type="text" id="maddress2" size="100"
							maxlength="200" value="${memberDTO.addr2}" readonly></input></td>
					</tr>
