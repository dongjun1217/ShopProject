...
<table width="70%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="td_default" align="center"><b>${orderAllDone[0].userid}</b> 님의 주문이
			안전하게 처리되었습니다.</td>
	</tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="td_default" height="35">${orderAllDone[0].orderName}</td>
				</tr>
				<tr>
					<td class="td_default" height="35"> 주소</td>
					<td class="td_default" height="35"> (${orderAllDone[0].post})<br>
						${orderAllDone[0].addr1}${orderAllDone[0].addr2}
					</td>
				</tr>
				
				<tr>
					<td class="td_default" height="35"> 휴대전화</td>
					<td class="td_default" height="35"> ${orderAllDone[0].phone}</td>
				</tr>
			</table>
	</tr>
	</td>
   ...
   <!--  변수 선언 -->
   <c:forEach var="dto" items="${orderAllDone}" varStatus="status">
   

   <c:set var="a" value="${a +(dto.gPrice*dto.gAmount)}"/>
    <!-- 누적 -->
				...
				<tr>
					...
					<td height="35" class="td_default" align="center">
						<span id = "num1">${dto.gAmount}</span>
					</td>
					<td height="35" class="td_default" align="center">
						<span>${dto.gPrice*dto.gAmount}</span>원
					</td>
				</tr>
</c:forEach>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<input type = 'text' id = 'total' value = '<c:out value="${a}"/>' readonly>원
					</td>
				</tr>
				<tr>
					<td class="td_default" width="150" height="35"> 결제수단</td>
					<td class="td_default" height="35" align = 'right'> 
					<span>${orderAllDone[0].payMethod}</span>
					</td>
				</tr>
			</table>
		</td>
