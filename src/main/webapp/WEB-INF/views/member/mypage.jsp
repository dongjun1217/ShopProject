...
<input type="text" value="${login.phone2}" name="phone2"  maxlength="4" id="input2">
-<input type="text" value="${login.phone3}" name="phone3" maxlength="4" id="input2">
  </th>
 </tr>
 <tr>
 <th>
...
<br>
<a class="a_black" href="memberDelete"> 회원 탈퇴 </a>
</center>
